...
//виклик посилання у консоль
const gallery = document.querySelector('.gallery');

gallery.addEventListener('click', function(event) {
    const galleryImage = event.target.closest('.gallery-item');
    if (galleryImage) {
        const largeImageSrc = galleryImage.querySelector('.gallery-image').getAttribute('data-source');
